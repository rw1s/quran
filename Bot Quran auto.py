...
Token = ("5839483305:AAF87w_8fAGMZx26r8Eq0VxwDKDOR5zVlZg")
bot = TeleBot(Token)
user_ch = ("vvinf") #معرف قناة النشر بدون @
key , dev = Mk() , Mk() 
dev.add(btn(text=" • المطور • ",url="t.me/GJQKP") )
key.add(btn(text="• تفعيل النشر التلقائي 🔛 •",callback_data="run"))
key.add(btn(text="• قناة النشر التلقائي  •", callback_data="ch")) 
key.add(btn(text=" • المطور • ",url="t.me/GJQKP"))
